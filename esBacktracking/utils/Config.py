...
def get_es_client() -> Elasticsearch:
    ...
    if _es_client is None:
        es_host = os.getenv("ES_HOST") or os.getenv("ELASTICSEARCH_URL") or "https://elastic.pnq.co.in/"
        es_user = os.getenv("ES_USER") or os.getenv("ES_USERNAME") or "pnqIndex"
        es_password = os.getenv("ES_PASSWORD") or "New#pnq#Change!"
